...
public class AutoCompleteDictionaryTrieTester {
	...
	{
		assertEquals("Testing size for empty dict", 0, emptyDict.sizeandPrint());
		//smallDict.printTree();
		assertEquals("Testing size for small dict", 8, smallDict.sizeandPrint());
	...
	{
		assertEquals("Testing isWord on small: Hello", true, smallDict.isWord("he"));
